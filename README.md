...
| --- | --- |
| &bull; ark-add-on<br>&bull; bin<br>&bull; quick_check.ini<br>&bull; setup.sh<br> | &bull; ark-add-on<br>&bull; bin<br>&bull; updatepatch<br>&bull; local_update.conf<br>&bull; patch_reuse |
